...
private $pass;
public function __construct($email,$nombre,$apellido,$sexo,$fecha_nacimiento,$direccion,$pass){
...
public function buscar(){
	...
	$sql = "select *, date_format(fechanacimiento, '%d/%m/%Y') as fechanacimiento from tusuario where(email = '$this->email')";
